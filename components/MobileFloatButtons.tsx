    ...
    <div className="fixed bottom-6 right-4 z-40 flex flex-col gap-3 lg:hidden">
      ...
      >
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
          <path
            d="M12 2.5C6.2 2.5 1.5 6.3 1.5 11C1.5 13.9 3.3 16.5 6.1 18.1L5.2 22L9.1 20C10.03 20.17 11 20.26 12 20.26C17.8 20.26 22.5 16.46 22.5 11C22.5 5.54 17.8 2.5 12 2.5Z"
            fill="#391B1B"
          />
